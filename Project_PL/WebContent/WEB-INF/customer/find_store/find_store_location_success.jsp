...
<body>
	...
	<div class="container">
		<div class="row">
					...
					<div class="panel-group category-products" id="accordian">
						...
						<div class="panel panel-default">
							...
							<div id="beverage" class="panel-collapse collapse">
								<div class="panel-body">
									<ul>
										<li><a href="${initParam.rootPath }/customer/find_store_name.do">매장명 검색</a></li>
										<li><a href="${initParam.rootPath }/customer/find_store_address_form.do">지역명 검색</a></li>
			...
			<!-- Filed -->
				...
				<!-- 1. 지도 노드 -->
				<div id="daumRoughmapContainer${requestScope.time.storeTimeStamp}"
	...
	<script charset="UTF-8">
		new daum.roughmap.Lander({
			"timestamp" : "${requestScope.time.storeTimeStamp}",   //1448509887985
			"key" : "${requestScope.map.storeKey}",
			"mapWidth" : "600",
			"mapHeight" : "300"
		}).render();
	</script>
...
<script charset="UTF-8">
		new daum.roughmap.Lander({
			"timestamp" : "1448681198107", //1448509887985
			"key" : "72z7",
			"mapWidth" : "600",
			"mapHeight" : "300"
		}).render();
