						...
						<div class="row">
							<div class="col-sm-4 col-sm-offset-2">
								...
								<div style="Text-align:center; padding:30px; border:1px;">
									...
									<form action="/Project_PL/customer/find_store_location.do" method ="post">
									<%-- <span class="class"> --><form:errors path="store.storeName"/> --%>
										
										<input type="text" name="storeName" placeholder="찾으시는 지역을 검색해주세요" />
										<font color="red">${requestScope.errorMessage }</font>
										<br><button type="submit" class="btn btn-default">검색</button>
									</form>
